        ...
        @if(session('cart'))
            @foreach(session('cart') as $id => $details)
                ...
                <tr data-id="{{ $id }}">
                    <td data-th="Product">
                        <div class="row">
                            <div class="col-sm-3 hidden-xs"><img src="{{ asset('public/uploads/product/' . $details['image']) }}" width="100"
                                    height="80" class="img-responsive" /></div>
                            <div class="col-sm-9">
                    ...
                    <td class="actions" data-th="">
                        <button class="btn btn-danger btn-sm remove-from-cart"><i class="fa fa-trash-o"></i>Xoá</button>
                    </td>
                </tr>
            @endforeach
        @endif
